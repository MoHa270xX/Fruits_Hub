class AppStrings {
  // --- Onboarding / Splash Screen Strings ---
  static const String appName = 'FRUITHUB'; // Based on the logo
  static const String skip = 'تخط';
  // Onboarding Screen 1
  static const String welcomeTitle = 'مرحبًا بك في ';
  static const String welcomeTitle1 = 'Fruit';
  static const String welcomeTitle2 = 'HUB';
  static const String welcomeBody =
      'اكتشف تجربة تسوق فريدة مع FruitHUB استكشف مجموعتنا الواسعة من الفواكه الطازجة الممتازة واحصل على أفضل العروض والجودة العالية.';

  // Onboarding Screen 2
  static const String searchAndShopTitle = 'ابحث وتسوق';
  static const String searchAndShopBody =
      'نقدم لك أفضل الفواكه المختارة. اطّلع على التفاصيل والصور والتقييمات للتأكد من اختيار الفاكهة المثالية.';
  static const String getStartedButton = 'ابدأ الآن';
  // --- Login Screen Strings ---
  static const String loginTitle = 'تسجيل دخول';
  ...
  static const String loginWithFacebook = 'تسجيل بواسطة فيسبوك';

  // --- New Account / Registration Screen Strings ---
  static const String newAccountTitle = 'حساب جديد';
  static const String fullNameHint = 'الاسم كامل';
